...
class Gait3Tonion(BaseModel):
    ...
    def get_optimizer(self, optimizer_cfg):
        optimizer = optim = Adam(
            [
                {"params": self.sil_model.layer2.parameters(), "lr": 1e-4},
                {"params": self.sil_model.layer3.parameters(), "lr": 1e-3},
                {"params": self.sil_model.layer4.parameters(), "lr": 1e-3},
                {"params": self.sil_model.BNNecks.parameters(), "lr": 1e-3},
                {"params": self.sil_model.FCs.parameters(), "lr": 1e-3},
                {"params": self.ske_model.layer2.parameters(), "lr": 1e-4},
                {"params": self.ske_model.layer3.parameters(), "lr": 1e-3},
                {"params": self.ske_model.layer4.parameters(), "lr": 1e-3},
                {"params": self.ske_model.BNNecks.parameters(), "lr": 1e-3},
                {"params": self.ske_model.FCs.parameters(), "lr": 1e-3},
            ],
            lr=1e-4,
            weight_decay=1.0e-5,
        )
    ...
    def forward(self, inputs):
        ...
        # print(f"sil:{sil_embed.mean().norm()}")
        # print(f"ske:{ske_embed.mean().norm()}")
        ...
        sil_feat_transpose = F.normalize(sil_feat_transpose)
        ske_feat_transpose = F.normalize(ske_feat_transpose)
        sil_anchor_feat_transpose = F.normalize(sil_anchor_feat_transpose)
        ...
        del sil_feat_transpose, ske_feat_transpose, sil_anchor_feat_transpose
